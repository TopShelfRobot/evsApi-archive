    ...
    public class StripeConnectController : ApiController
    {
        ...
        public HttpResponseMessage StripeResponse()  //Int32 OwnerId
        {
            try
            {
                ...
                //var stripeService = new StripeOAuthTokenService(ConfigurationManager.AppSettings["StripeSecret"]);      StripeApiKey
                ...
                owner.StripePublishableKey = response.StripePublishableKey;
